...
?>
    ...
    <div class="container">
        ...
        <hr>
        <p>Legg til strafferegi ved å velge strafferegi fra kategori og legge inn en (positiv) verdi i tid brukt enten
            på form time:minutt eller time som desimaltall.</p>
        ...
        <table class="table table-striped table-hover">
            ...
            foreach ($arbeidListe as $arbeid) {
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $arbeid->getStatus(); ?>
                    </td>
                    <td><a href="?a=regi/minregi/<?php echo $arbeid->getId(); ?>">Detaljer</a></td>
                    <td><?php $arbeid->getStatus() == 'Godkjent' || $arbeid->getStatus() == 'Underkjent' ? '' : '<button class="btn btn-danger" onclick="slett(' . $arbeid->getId() . ')">Slett</button>'; ?></td>
                </tr>
                <?php
            }
            ?>
