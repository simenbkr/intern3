...
<div class="col-md-4">
	...
	foreach($mndkryss as $navn => $antall){
		...
		<tr>
			...
			switch($navn){
				case 'Pant':
					$pris = \intern3\Drikke::medId(1)->getPris()*$antall;
					break;
				case 'Øl':
					$pris = \intern3\Drikke::medId(2)->getPris()*$antall;
					break;
				case 'Cider':
					$pris = \intern3\Drikke::medId(3)->getPris()*$antall;
					break;
				case 'Carlsberg':
					$pris = \intern3\Drikke::medId(4)->getPris()*$antall;
					break;
				case 'Rikdom':
					$pris = \intern3\Drikke::medId(5)->getPris()*$antall;
					break;
			}
				echo $pris;
				$totalt += $pris;
