...
?>
    ...
    <div class="container">
        <h1>Vinkjeller » Sorter på</h1>
        <div class="col-lg-12" style="display:table; margin: auto; margin-top:20%">
            <div id="showgrid">
                <div class="row">
                    <div class="column">
                        <a href="?a=vinkjeller/kryssing/navn"><button class="btn btn-primary btn-huge">Navn</button></a>
                    </div>
                    <div class="column">
                        <a href="?a=vinkjeller/kryssing/type"><button class="btn btn-primary btn-huge">Type</button></a>
                    </div>
                    <?php /*
                    <div class="column">
