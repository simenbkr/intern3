...
?>
    ...
    <script>
        ...
        function del(email) {
            $.ajax({
                url: '?a=utvalg/romsjef/veteran/' + email,
                type: 'DELETE',
    ...
    <div class="container">
        ...
        <h1>Romsjef &raquo; Veteran e-postliste</h1>

        <p>Disse kan også administreres ved bruk av Google konto på <a
        ...
        <p>Knapper kan respondere tregt ettersom det må kommunisere med Google sitt API. Trykk derfor kun en gang, og
            vent til tilbakemelding dukker opp.</p>
