...
<script>
    ...
    function submit(){
        ...
        $.ajax({
            type: 'POST',
            url: '?a=vinkjeller/pinkode/',
            data: 'pinkode=' + pinkoden.join('') + '&ansvarlig=' + beboerId + '&vinid=' + '<?php echo $vinid; ?>' +'&beboerene=' + '<?php echo $idene; ?>',
            method: 'POST',
            success: function (data) {
                //window.location.href = "?a=journal/kryssing/" + beboerId;
                <?php /*window.location.href = '?a=vinkjeller/kryssing/<?php echo $vinid; ?>/<?php echo $beboer->getId();?>/<?php implode('/', $idene); ?>';
 */ ?>
