...
';
    ...
    <div class="col-lg-4">
        <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
            ...
            <table class="table table-bordered">
                <tr>
                    <th>Fødselsdato</th>
                    <td><input type="text" class="form-control" name="fodselsdato" size="10"
                               value="<?php echo isset($_POST['fodselsdato']) ? $_POST['fodselsdato'] : $beboer->getFodselsdato(); ?>"><br>(åååå-mm-dd)
                    </td>
                </tr>
                <tr>
                    <th>Epost</th>
                    <td><input type="text" class="form-control" name="epost"
                               value="<?php echo isset($_POST['epost']) ? $_POST['epost'] : $beboer->getEpost(); ?>">
                    </td>
                </tr>
                <tr>
                    <th>Telefon</th>
                    <td><input type="text" class="form-control" name="telefon" size="12"
                               value="<?php echo isset($_POST['telefon']) ? $_POST['telefon'] : $beboer->getTelefon(); ?>">
                    </td>
                </tr>
                <tr>
                    <th>Adresse</th>
                    <td><input type="text" class="form-control" name="adresse"
                               value="<?php echo isset($_POST['adresse']) ? $_POST['adresse'] : $beboer->getAdresse(); ?>">
                    </td>
                </tr>
                <tr>
                    <th>Postnummer</th>
                    <td><input type="text" class="form-control" name="postnummer" size="4"
                               value="<?php echo isset($_POST['postnummer']) ? $_POST['postnummer'] : $beboer->getPostnummer(); ?>">
                    </td>
                </tr>
                <tr>
                    <th>Skole</th>
                ...
                <tr>
                    <th>Klassetrinn</th>
                    <td><input type="text" name="klassetrinn" class="form-control" size="1"
                               value="<?php echo isset($_POST['klassetrinn']) ? $_POST['klassetrinn'] : $beboer->getKlassetrinn(); ?>">
                    </td>
                </tr>
            </table>
        ...
        <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
            ...
            <table class="table table-bordered">
                <tr>
                    ...
                    <td><input type="checkbox" name="resepp" value="1" <?php if ($prefs->getResepp()) { ?>
                               checked="checked"><?php } ?></td>
                </tr>

                <tr>
                    <td>Jeg ønsker å stå på krysselista i vinkjelleren</td>
                    <td><input type="checkbox" name="vinkjeller" value="1" <?php if ($prefs->getVinkjeller()) { ?>
                               checked="checked"><?php } ?></td>
                </tr>

                <tr>
                    <td>Jeg vil ha en pinkode på krysselista</td>
                    <td><input type="checkbox" name="pinboo" value="1" <?php if ($prefs->harPinkode()) { ?>
                               checked="checked"><?php } ?></td>
                </tr>

                <tr>
                    <td>Min pinkode er:</td>
                    <td><input type="text" name="pinkode" class="form-control" style="width:75%"
                               value="<?php echo $prefs->getPinkode(); ?>"</td>
                </tr>

                <tr>
                    <td>Min pinkode til vinkjelleren er:</td>
                    <td><input type="text" name="vinpin" class="form-control" style="width:75%"
                               value="<?php echo $prefs->getVinPinkode(); ?>"</td>
                </tr>
        ...
        <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="tildeltvakt" value="1" <?php if ($epostInst['tildelt'] == 1) { ?>
                               checked="checked"><?php } ?></td>
                </tr>
                <tr>
                    <td>når det er 24 timer igjen til å sitte vakt</td>
                    <td><input type="checkbox" name="vakt" value="1" <?php if ($epostInst['snart_vakt'] == 1) { ?>
                               checked="checked"><?php } ?></td>
                </tr>
                <tr>
                    <td>når noen vil bytte eller gi bort en vakt</td>
                    <td><input type="checkbox" name="vaktbytte" value="1" <?php if ($epostInst['bytte'] == 1) { ?>
                               checked="checked"><?php } ?></td>
                </tr>
                <tr>
                    <td>når kosesjef har planlagt et utleie</td>
                    <td><input type="checkbox" name="utleie" value="1" <?php if ($epostInst['utleie'] == 1) { ?>
                               checked="checked"><?php } ?></td>
                </tr>
                <tr>
                    <td>når det er 24 timer igjen til å stå barvakt</td>
                    <td><input type="checkbox" name="barvakt" value="1" <?php if ($epostInst['barvakt'] == 1) { ?>
                               checked="checked"><?php } ?></td>
                </tr>
            </table>
            <p><input type="submit" class="btn btn-primary" value="Lagre"></p>
    ...
    <div class="col-sm-3">
        <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
            ...
            <p style="color: #990;">Obs: Det anbefales å bruke et sterkt passord, særlig om man er utvalgsmedlem og har
                admintilgang. Minstekravet er en lengde på 8 tegn.</p>
            <table class="table table-bordered">
                <tr>
                    <th>Nytt passord</th>
