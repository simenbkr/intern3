    ...
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <table class="table table-bordered table-responsive">
                <tr>
                    <td>Fornavn:</td>
                    <td><input type="text" class="form-control" name="fornavn"
                               value="<?php echo !isset($beboer) || $beboer == null ? '' : $beboer->getFornavn(); ?>">
                    </td>
                </tr>
                <tr>
                    <td>Mellomnavn:</td>
                    <td><input type="text" class="form-control" name="mellomnavn"
                               value="<?php echo !isset($beboer) || $beboer == null ? '' : $beboer->getMellomnavn(); ?>">
                    </td>
                </tr>
                <tr>
                    <td>Etternavn:</td>
                    <td><input type="text" class="form-control" name="etternavn"
                               value="<?php echo !isset($beboer) || $beboer == null ? '' : $beboer->getEtternavn(); ?>">
                    </td>
                </tr>
                <tr>
                    <td>Født (år-mnd-dag):</td>
                    <td><input type="text" class="form-control" id="datepicker" name="fodselsdato"
                ...
                <tr>
                    <td>Postnummer:</td>
                    <td><input type="text" class="form-control" name="postnummer"
                               value="<?php echo !isset($beboer) || $beboer == null ? '' : $beboer->getPostnummer(); ?>">
                    </td>
                </tr>
                <tr>
                    <td>Telefon:</td>
                    <td><input type="text" class="form-control" name="mobil"
