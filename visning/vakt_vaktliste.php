...
<div class="col-md-12">
    ...
    <div class="col-md-6">
        <b>Du har sittet <?php echo ($har_sittet = $cd->getAktivBruker()->antallVakterHarSittet()); ?> vakt(er) og skal sitte
            totalt <?php echo $cd->getAktivBruker()->antallVakterSkalSitte(); ?> vakter. Du er satt opp på <?php echo count($egne_vakter) - $har_sittet; ?> fremtidige vakter.</b>
        <h3>Dine vakter:</h3>
