...
<form action="" method="post">
  ...
  <table class="table table-bordered table-responsive">
    <tr>
      <td>Fornavn:</td>
      <td><input type="text" name="fornavn" class="form-control" value="<?php echo !isset($beboer) || $beboer == null ? '' : $beboer->getFornavn(); ?>"></td>
    </tr>
    <tr>
      <td>Mellomnavn:</td>
      <td><input type="text" name="mellomnavn" class="form-control" value="<?php echo !isset($beboer) || $beboer == null ? '' : $beboer->getMellomnavn(); ?>"></td>
    </tr>
    <tr>
      <td>Etternavn:</td>
      <td><input type="text" name="etternavn" class="form-control" value="<?php echo !isset($beboer) || $beboer == null ? '' : $beboer->getEtternavn(); ?>"></td>
    </tr>
    <tr>
      <td>Født (år-mnd-dag):</td><?php /*<input type="text" name="dato" id="datepicker"/> */?>
      <td><input type="text" id="datepicker" class="form-control" name="fodselsdato" value="<?php echo !isset($beboer) || $beboer == null ? '' : $beboer->getFodselsdato(); ?>"></td>
    </tr>
    <tr>
      <td>Adresse:</td>
      <td><input type="text" name="adresse" class="form-control" value="<?php echo !isset($beboer) || $beboer == null ? '' : $beboer->getAdresse(); ?>"></td>
    </tr>
    <tr>
      <td>Postnummer:</td>
      <td><input type="text" name="postnummer" class="form-control" value="<?php echo !isset($beboer) || $beboer == null ? '' : $beboer->getPostnummer(); ?>"></td>
    </tr>
    <tr>
      <td>Telefon:</td>
      <td><input type="text" name="mobil" class="form-control" value="<?php echo !isset($beboer) || $beboer == null ? '' : $beboer->getTelefon(); ?>"></td>
    </tr>

    <tr>
      <td>E-post:</td>
      <td><input type="text" name="epost" class="form-control" value="<?php echo !isset($beboer) || $beboer == null ? '' : $beboer->getEpost(); ?>"></td>
    </tr>
